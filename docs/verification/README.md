...
| [classical-baselines.md](classical-baselines.md) | MiniRocket matches aeon's arithmetic; on the turbofan task the tuned trees per channel beat the network trained from scratch by 26 % at 200 labelled windows (validation, confirmed) |
